...
Namespace WindowsApplication3
	...
	Partial Public Class DataSet1
		...
		Friend Sub InitVars(ByVal initTable As Boolean)
			Me.tableCustomerInfo = (DirectCast(MyBase.Tables("CustomerInfo"), CustomerInfoDataTable))
		...
		Partial Public Class CustomerInfoDataTable
			...
			Default Public ReadOnly Property Item(ByVal index As Integer) As CustomerInfoRow
				Get
					Return (DirectCast(Me.Rows(index), CustomerInfoRow))
				End Get
			End Property
            ...
            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            Public Function AddCustomerInfoRow(ByVal CustomerID As Integer, ByVal FirstName As String, ByVal LastName As String, ByVal Date1 As Date) As CustomerInfoRow
                Dim rowCustomerInfoRow As CustomerInfoRow = (DirectCast(Me.NewRow(), CustomerInfoRow))
                Dim columnValuesArray() As Object = {CustomerID, FirstName, LastName, Date1}
			...
			Public Overrides Function Clone() As Global.System.Data.DataTable
				Dim cln As CustomerInfoDataTable = (DirectCast(MyBase.Clone(), CustomerInfoDataTable))
				cln.InitVars()
				Return cln
			End Function
			...
			Public Function NewCustomerInfoRow() As CustomerInfoRow
				Return (DirectCast(Me.NewRow(), CustomerInfoRow))
			End Function
			...
			Protected Overrides Sub OnRowChanged(ByVal e As Global.System.Data.DataRowChangeEventArgs)
				...
				RaiseEvent CustomerInfoRowChanged(Me, New CustomerInfoRowChangeEvent((DirectCast(e.Row, CustomerInfoRow)), e.Action))
			End Sub

			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
			Protected Overrides Sub OnRowChanging(ByVal e As Global.System.Data.DataRowChangeEventArgs)
				MyBase.OnRowChanging(e)
				RaiseEvent CustomerInfoRowChanging(Me, New CustomerInfoRowChangeEvent((DirectCast(e.Row, CustomerInfoRow)), e.Action))
			End Sub

			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
			Protected Overrides Sub OnRowDeleted(ByVal e As Global.System.Data.DataRowChangeEventArgs)
				MyBase.OnRowDeleted(e)
				RaiseEvent CustomerInfoRowDeleted(Me, New CustomerInfoRowChangeEvent((DirectCast(e.Row, CustomerInfoRow)), e.Action))
			End Sub

			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
			Protected Overrides Sub OnRowDeleting(ByVal e As Global.System.Data.DataRowChangeEventArgs)
				MyBase.OnRowDeleting(e)
				RaiseEvent CustomerInfoRowDeleting(Me, New CustomerInfoRowChangeEvent((DirectCast(e.Row, CustomerInfoRow)), e.Action))
			End Sub
		...
		Partial Public Class CustomerInfoRow
			...
			Friend Sub New(ByVal rb As Global.System.Data.DataRowBuilder)
				MyBase.New(rb)
				Me.tableCustomerInfo = (DirectCast(Me.Table, CustomerInfoDataTable))
			End Sub
			...
			Public Property CustomerID() As Integer
				Get
					Try
						Return (DirectCast(Me(Me.tableCustomerInfo.CustomerIDColumn), Integer))
			...
			Public Property FirstName() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableCustomerInfo.FirstNameColumn), String))
					Catch e As Global.System.InvalidCastException
			...
			Public Property LastName() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableCustomerInfo.LastNameColumn), String))
					Catch e As Global.System.InvalidCastException
            ...
            Public Property Date1() As Date
                Get
                    Try
                        Return (DirectCast(Me(Me.tableCustomerInfo.DateTimeColumn), Global.System.DateTime))
                    Catch e As Global.System.InvalidCastException
                        Throw New Global.System.Data.StrongTypingException("The value for column 'DateTime' in table 'CustomerInfo' is DBNull.", e)
                    End Try
                End Get
                Set(ByVal value As Date)
                    Me(Me.tableCustomerInfo.DateTimeColumn) = value
                End Set
            End Property
			...
			Public Function IsDateTimeNull() As Boolean
				Return Me.IsNull(Me.tableCustomerInfo.DateTimeColumn)
			End Function

			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
			Public Sub SetDateTimeNull()
				Me(Me.tableCustomerInfo.DateTimeColumn) = Global.System.Convert.DBNull
			End Sub
		End Class
