...
Namespace WindowsApplication3
	...
	Partial Public Class DataSet1
		...
		Partial Public Class CustomerInfoDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddCustomerInfoRow(ByVal CustomerID As Integer, ByVal FirstName As String, ByVal LastName As String, ByVal DateTime As System.DateTime) As CustomerInfoRow
				Dim rowCustomerInfoRow As CustomerInfoRow = (CType(Me.NewRow(), CustomerInfoRow))
				Dim columnValuesArray() As Object = { CustomerID, FirstName, LastName, DateTime}
			...
			Private Sub InitClass()
				...
				Me.columnDateTime = New Global.System.Data.DataColumn("DateTime", GetType(Global.System.DateTime), Nothing, Global.System.Data.MappingType.Element)
		...
		Partial Public Class CustomerInfoRow
			...
			Public Property DateTime() As System.DateTime
				Get
					Try
						Return (CDate(Me(Me.tableCustomerInfo.DateTimeColumn)))
					Catch e As Global.System.InvalidCastException
